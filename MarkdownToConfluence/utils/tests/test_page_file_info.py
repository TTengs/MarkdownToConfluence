...
def test_get_all_md_paths():
    root=str(pathlib.Path(__file__).parent.resolve()) + '/testdocs/DAM Center 5'
    testpaths=[f'{root}/DC 5.0/5 Security/Configuring CORS.md', f'{root}/DC 5.0/5 Security/index.md',
                f'{root}/DC 5.0/index.md', f'{root}/index.md']
...
def test_get_all_page_names_in_filesystem():
    root=str(pathlib.Path(__file__).parent.resolve()) + '/testdocs/DAM Center 5'
    print(root)
    testnames = ['DC5.0.0 5 Security', 'DC5.0.0 Configuring CORS', 'DC 5.0', 'DAM Center 5']
