...
def test_get_abs_path_from_relative():
    ...
    assert str(get_abs_path_from_relative('MarkdownToConfluence/utils/tests/testdocs/page 1/index.md', source_path, './MarkdownToConfluence')) == f'{(dirname(source_path))}/testdocs/page 1/index.md'
